...
{ 
    ...
    function _validateSignature(
        PackedUserOperation calldata userOp, // PackedUserOperation data structure passed as input
        bytes32 userOpHash // Hash of the PackedUserOperation without the signatures
